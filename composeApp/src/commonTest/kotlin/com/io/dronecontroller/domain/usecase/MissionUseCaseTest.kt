...
class MissionUseCaseTest {
    ...
    @Test
    fun `ミッション送信成功時はSuccessを返す`() = runTest {
    ...
    @Test
    fun `ミッション送信失敗時はErrorを返す`() = runTest {
    ...
    @Test
    fun `ミッション開始成功時はSuccessを返す`() = runTest {
    ...
    @Test
    fun `ミッション開始失敗時はErrorを返す`() = runTest {
    ...
    @Test
    fun `ミッション停止成功時はSuccessを返す`() = runTest {
    ...
    @Test
    fun `ミッション停止失敗時はErrorを返す`() = runTest {
    ...
    @Test
    fun `ミッション一時停止成功時はSuccessを返す`() = runTest {
    ...
    @Test
    fun `ミッション一時停止失敗時はErrorを返す`() = runTest {
